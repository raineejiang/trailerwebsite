...
twelve_angry_men = media.Movie(
    "12 Angry Men", "A story of a jury made up of 12 men as"
    "they deliberate the guilt or acquittal of a defendant"
...
goodfellas = media.Movie(
    "Goodfellas",
    "The rise and fall of mob associate Henry Hill and"
...
it_is_a_wonderful_life = media.Movie(
    "It's a Wonderful Life",
    "An angel is sent from Heaven to help a desperately frustrated"
    "businessman by showing him what life would have been like"
...
life_is_beautiful = media.Movie(
    "Life Is Beautiful",
    "When an open-minded Jewish librarian and his son become"
    "victims of the Holocaust, he uses a perfect mixture of will, "
    "humor and imagination to protect his son from the dangers"
    "around their camp.",
    "https://vignette1.wikia.nocookie.net/disney/images/b/bb/"
    "Life_is_Beautiful.jpg/revision/latest?cb=20121111011203",
    "https://www.youtube.com/watch?v=pAYEQP8gx3w")


# Create a list to store all the movie instances
movies = [the_shawshank_redemption, twelve_angry_men, pulp_fiction,
          goodfellas, it_is_a_wonderful_life, life_is_beautiful]

# Open the movie trailer website based on the data served
# by the movie instances list
